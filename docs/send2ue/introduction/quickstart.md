...
First thing you need to do is download the latest versioned zip file from the [releases page](https://github.com/JoshQuake/BlenderTools/releases?q=Send+to+unreal&expanded=true)
