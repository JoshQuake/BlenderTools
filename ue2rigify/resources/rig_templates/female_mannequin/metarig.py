...
def create(obj):  # noqa
    ...
    add_bone_collection('Face', ui_row=1, sel_set=False, color_set_id=5)
    add_bone_collection('Face (Primary)', ui_row=2, sel_set=False, color_set_id=2)
    add_bone_collection('Face (Secondary)', ui_row=2, sel_set=False, color_set_id=3)
    add_bone_collection('Torso', ui_row=3, sel_set=False, color_set_id=3)
    add_bone_collection('Torso (Tweak)', ui_row=4, sel_set=False, color_set_id=4)
    add_bone_collection('Fingers', ui_row=5, sel_set=False, color_set_id=6)
    add_bone_collection('Fingers (Detail)', ui_row=6, sel_set=False, color_set_id=5)
    add_bone_collection('Arm.L (IK)', ui_row=7, sel_set=False, color_set_id=2)
    add_bone_collection('Arm.L (FK)', ui_row=8, sel_set=False, color_set_id=5)
    add_bone_collection('Arm.L (Tweak)', ui_row=9, sel_set=False, color_set_id=4)
    add_bone_collection('Arm.R (IK)', ui_row=7, sel_set=False, color_set_id=2)
    add_bone_collection('Arm.R (FK)', ui_row=8, sel_set=False, color_set_id=5)
    add_bone_collection('Arm.R (Tweak)', ui_row=9, sel_set=False, color_set_id=4)
    add_bone_collection('Leg.L (IK)', ui_row=10, sel_set=False, color_set_id=2)
    add_bone_collection('Leg.L (FK)', ui_row=11, sel_set=False, color_set_id=5)
    add_bone_collection('Leg.L (Tweak)', ui_row=12, sel_set=False, color_set_id=4)
    add_bone_collection('Leg.R (IK)', ui_row=10, sel_set=False, color_set_id=2)
    add_bone_collection('Leg.R (FK)', ui_row=11, sel_set=False, color_set_id=5)
    add_bone_collection('Leg.R (Tweak)', ui_row=12, sel_set=False, color_set_id=4)
    add_bone_collection('Root', ui_row=15, sel_set=False, color_set_id=1)
