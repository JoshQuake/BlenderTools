...
fk_to_source_mode_settings = {
    ...
    'control_rig': {
        ...
        'red_sphere_bones': False,
        'relationship_lines': False,
        'visible_bone_collections': ["Root", "Arm.L (FK)", "Arm.L (Tweak)", "Arm.R (Tweak)", "Arm.R (FK)", "Leg.L (Tweak)", "Leg.R (Tweak)", "Fingers (Detail)", "Fingers", "Torso", "Torso (Tweak)", "Leg.L (FK)", "Leg.R (FK)"]
    }}
